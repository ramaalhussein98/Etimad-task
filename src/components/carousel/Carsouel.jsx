      ...
      <Slider {...settings} id="Slider">
        <div className="d-flex">
          <div className={classes.sliderContent}>
            ...
            <p>
              يتيح حركة تعاملات مفتوحة بين الجهات الحكومية والقطاع الخاص حيث
              يتيح للجهات الحكومية سهولة شراء السلع والخدمات بشكل إلكتروني،
              وتوفير سلسلة كاملة من دورة الشراء إلى توصيل والاستلام والدفع...{" "}
            </p>
          </div>
        ...
        <div className="d-flex">
          <div className={classes.sliderContent}>
            ...
            <p>
              يمكنك استعراض كافة المنافسات الحكومية المطروحة من خلال الضغط على
              (استعراض المنافسات) في القائمة الرئيسية
            </p>
          </div>
          <div className={classes.imgSliderDiv}>
        ...
        <div className="d-flex">
          <div className={classes.sliderContent}>
            ...
            <p>يمكنك إصدار الضمان البنكي عبر الدخول لمنصة اعتماد إلكترونياً</p>
          </div>
          <div className={classes.imgSliderDiv}>
